...
export const metadata: Metadata = {
	...
	description: "Discover, share, and explore food through immersive visuals. BiteScout reimagines food discovery with TikTok-style feeds of real food from real people.",
