							...
							<div className="flex items-start gap-6">
								...
								<div>
									...
									<p className="text-card-foreground leading-relaxed font-light">
										We don&apos;t ask users to read reviews. We show them
										exactly what they could eat next — via vibrant, full-screen
										food content that makes your mouth water.
									</p>
								</div>
							</div>
						</Card>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						...
						>
							...
							<p className="text-card-foreground text-sm leading-relaxed font-light">
								Immersive TikTok-style feed with trending dishes, suggestions,
						...
						>
							...
							<p className="text-card-foreground text-sm leading-relaxed font-light">
								Find dishes by name, cuisine, restaurant, dietary needs,
								allergens, and location
							</p>
						</Card>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-10">
						...
						>
							...
							<p className="text-card-foreground font-light leading-relaxed">
								...
								Wants to discover new dishes through beautiful visuals and
								authentic content.
							</p>
						</Card>
						...
						>
							...
							<p className="text-card-foreground font-light leading-relaxed">
								...
								endless reviews. Values quick, visual decision-making for food
								choices.
							</p>
						</Card>
						...
						>
							...
							<p className="text-card-foreground font-light leading-relaxed">
								...
								nut-free, and more. Needs reliable, visual confirmation of
								dietary compliance.
							</p>
						</Card>
					</div>
				...
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-20">
						...
						<p className="text-xl text-background/80 max-w-3xl mx-auto font-light">
							Modern, playful, classy, and inclusive — just like the food
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						...
						<div className="text-center">
							...
							<p className="text-background/70 font-light">
								Stylized bite mark on a scout badge
							</p>
						</div>
					</div>
				</div>
