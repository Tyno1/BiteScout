...
const mockUseForceSignOut = useForceSignOut as jest.MockedFunction<typeof useForceSignOut>;
...
describe("RefreshButton", () => {
  ...
  test("applies correct default variant", () => {
    ...
    render(<RefreshButton />);
    const button = screen.getByRole("button");
    expect(button).toHaveClass("border", "border-primary", "bg-transparent", "text-primary");
  });
  ...
  test("combines all props correctly", () => {
    ...
    render(<RefreshButton text="Custom Text" variant="solid" size="sm" className="custom-class" />);
    const button = screen.getByRole("button");
