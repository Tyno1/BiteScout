...
describe("IconButton", () => {
	...
	test("handles click events", () => {
		...
		render(
			<IconButton icon={mockIcon} variant="solid" onClick={handleClick} />,
		);
	...
	test("applies correct size styles", () => {
		const { rerender } = render(
			<IconButton icon={mockIcon} variant="solid" size="xs" />,
		);
	...
	test("applies custom className", () => {
		render(
			<IconButton icon={mockIcon} variant="solid" className="custom-class" />,
		);
		const button = screen.getByRole("button");
	...
	test("applies correct button type", () => {
		const { rerender } = render(
			<IconButton icon={mockIcon} variant="solid" type="submit" />,
		);
