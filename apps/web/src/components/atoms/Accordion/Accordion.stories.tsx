...
export const FAQStyle: Story = {
    ...
    items: [
      {
        ...
        content:
          "BiteScout is a comprehensive restaurant discovery and management platform that connects food lovers with amazing dining experiences while helping restaurants grow their business.",
      },
      {
        id: "faq-2",
        title: "How does the recommendation system work?",
        content:
          "Our AI-powered recommendation system analyzes your preferences, dining history, and location to suggest restaurants that match your taste and dietary requirements.",
      },
      {
        id: "faq-3",
        title: "Can I book tables through BiteScout?",
        content:
          "Yes! You can book tables directly through our platform. We partner with restaurants to provide seamless booking experiences with real-time availability.",
      },
    ],
    variant: "bordered",
    size: "md",
  ...
  parameters: {
    docs: {
      description: {
        story:
          "This example shows how the Accordion component can be used for FAQ sections with a clean, organized layout.",
      },
    },
  },
};
...
export const FeatureList: Story = {
    ...
    items: [
      {
        ...
        content:
          "Our AI analyzes your preferences and dining history to suggest restaurants you'll love.",
      },
      {
        id: "feature-2",
      ...
      },
      {
        ...
        content:
          "Comprehensive tools for restaurants to manage their online presence and customer relationships.",
      },
    ],
    variant: "elevated",
    size: "lg",
  ...
  parameters: {
    docs: {
      description: {
        story:
          "This example shows how the Accordion component can be used to showcase product features with an elevated design.",
      },
    },
  },
};
