      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Upload new images to your gallery. They will be automatically added to your restaurant's
            media collection and can then be assigned as logo or profile image.
          </p>
          <MediaUpload
            uploadMode="manual"
            uploadedFiles={[]}
      ...
      <div className="space-y-6">
        <div>
                  ...
                  <div className="mt-2 text-sm text-muted-foreground">
                    <p>
                      ...
                      {assignedImages.logo.assignedAt
                        ? new Date(assignedImages.logo.assignedAt).toLocaleDateString()
                        : "Unknown"}
                    </p>
                  ...
                  <div className="mt-2 text-sm text-muted-foreground">
                    <p>
                      ...
                      {assignedImages.profileImage.assignedAt
                        ? new Date(assignedImages.profileImage.assignedAt).toLocaleDateString()
                        : "Unknown"}
                    </p>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Click on any image below to assign it as your logo or profile image. Newly uploaded
            ...
            <Alert status="information" className="mb-4">
              Quick Tip: Click on any image below to assign it as your profile image. This image
              will be displayed in the hero section of your restaurant profile.
            </Alert>
            <Gallery
