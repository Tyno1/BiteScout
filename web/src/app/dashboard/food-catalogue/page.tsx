...
const MEAL_COMPONENTS = [
  ...
  'Beverage', 'Salad', 'Side Dish'
] as const;

const ALLERGENS = ['Gluten', 'Dairy', 'Nuts', 'Shellfish', 'Eggs', 'Soy'] as const;
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select 
            ...
            onChange={(e) => setNewFood(prev => ({...prev, cuisineType: e.target.value as CuisineType}))}
            className="w-full border p-2 rounded"
          >
        ...
        <div>
          ...
          <select 
            ...
            onChange={(e) => setNewFood(prev => ({...prev, mealComponent: e.target.value as MealComponent}))}
            className="w-full border p-2 rounded"
          >
