...
import type{ RegisterRequest, RegisterResponse } from "@shared/types/auth/register";
	...
	try {
		...
		try {
			...
			if (axios.isAxiosError(error) && error.response?.data) {
				...
				const message = errorMessages[apiError.code] || apiError.message || 'Registration failed. Please try again.';
